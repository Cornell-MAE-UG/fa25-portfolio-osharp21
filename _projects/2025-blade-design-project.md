...
Operating speed was treated as a design variable within the imposed limit. Across the configurations we evaluated, predicted power increased as rotational speed approached the 2000 rpm constraint, supporting a target operating condition near 2000 rpm. The final blade retained the chosen baseline chord distribution and NACA 4412 airfoil profile, while modifying twist to target an approximately constant 6° angle of attack along the span at the design condition.
